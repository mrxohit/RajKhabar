...
const BottomNav = ({ openSidebar, openSearch }) => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-[#FFf] border-t p-2 flex justify-around items-center shadow-md">
      <Link to="/">
        <div className="flex cursor-pointer flex-col items-center text-gray-600 text-xs">
      ...
      <div
        onClick={openSearch}
        className="flex flex-col cursor-pointer items-center text-gray-600 text-xs"
      >
